...
// Read Data as a string
                    ...
                    return; //revents execution from continuing after the socket closes
    ...
    public static void main(String[] args) throws java.io.IOException {
        ...
        try (ServerSocket serverSocket = new ServerSocket(port)) {
            ...
            while (true) {
                    Socket socket = serverSocket.accept(); // accepts the client
                    socket.setSoTimeout(30_000); // safety
                    new ServerThread(socket).start(); // start a new thread for each client
